...
func (t Training) distance() float64 {
	...
	trainingDistance := float64(t.Action) * t.LenStep / float64(MInKm)
...
func (t Training) meanSpeed() float64 {
	...
	trainingSpeed := t.distance() / t.Duration.Hours()
...
func (s Swimming) meanSpeed() float64 {
	...
	swimmingMeanSpeed := float64(s.LengthPool*s.CountPool) / MInKm / s.Duration.Hours()
